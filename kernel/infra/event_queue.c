...
int ksu_event_queue_push(struct ksu_event_queue *queue, __u16 type,
			 __u16 flags, const void *payload, __u32 len,
			 gfp_t gfp)
{
...
__poll_t ksu_event_queue_poll(struct ksu_event_queue *queue,
